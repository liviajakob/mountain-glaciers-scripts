...
#Execution example Himalayas: ./mntgla-run.sh hma-gridcells.txt
#Execution example Alaska: ./mntgla-run.sh alaska-gridcells.txt

#Execution example with time display: time ./mntgla-run.sh hma-gridcells.txt
#Execution example with time display: time ./mntgla-run.sh alaska-gridcells.txt
